...
class _ProfileTabPageState extends State<ProfileTabPage> {
  ...
  Future getDetails() async{
    ...
    log("verii"+prefs.getString("email").toString());
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                            ...
                            child: Text("Profile",style: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.bold),)
                        ),
                      ),
                      kHeightBig,
                      kHeightVeryBig,
                      SizedBox(
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: ()=>openDialogCaller(context),
                                // UrlLauncher.launch('tel:+${9815236505}'),

                          // Navigator.push(context, MaterialPageRoute(builder: (context)=>TabPage()));

                            child: Text("Customer Support",style: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.bold),)
                        ),
                      ),
                      kHeightVeryBig,
                      kHeightBig,
                      SizedBox(
                        ...
                        child: ElevatedButton(
                            ...
                            child: Text("Privacy Policy",style: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.bold),)
                        ),
                      ),
                      // kHeightMedium,
                      kHeightBig,
